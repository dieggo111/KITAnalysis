...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startBox = QtWidgets.QLineEdit(self.tab_1)
        self.startBox.setGeometry(QtCore.QRect(10, 70, 113, 20))
        self.startBox.setText("")
        self.startBox.setObjectName("startBox")
        self.pathBox = QtWidgets.QLineEdit(self.tab_1)
        self.pathBox.setGeometry(QtCore.QRect(180, 130, 251, 20))
        self.pathBox.setText("")
        self.pathBox.setObjectName("pathBox")
        self.start_label = QtWidgets.QLabel(self.tab_1)
        self.start_label.setGeometry(QtCore.QRect(10, 40, 51, 21))
...
"font: 75 10pt \"Verdana\";")
        ...
        self.valueBox = QtWidgets.QLineEdit(self.tab_1)
        self.valueBox.setGeometry(QtCore.QRect(480, 70, 113, 20))
        self.valueBox.setText("")
        self.valueBox.setObjectName("valueBox")
        self.endBox = QtWidgets.QLineEdit(self.tab_1)
        self.endBox.setGeometry(QtCore.QRect(180, 70, 113, 20))
        self.endBox.setText("")
        self.endBox.setObjectName("endBox")
        self.path_label = QtWidgets.QLabel(self.tab_1)
        self.path_label.setGeometry(QtCore.QRect(180, 100, 121, 21))
        self.path_label.setObjectName("path_label")
        self.project_label_2 = QtWidgets.QLabel(self.tab_1)
        self.project_label_2.setGeometry(QtCore.QRect(480, 100, 121, 21))
        self.project_label_2.setObjectName("project_label_2")
        self.paraBox = QtWidgets.QComboBox(self.tab_1)
        self.paraBox.setGeometry(QtCore.QRect(350, 70, 81, 22))
        self.paraBox.setObjectName("paraBox")
        self.paraBox.addItem("")
        self.paraBox.addItem("")
        self.projectBox = QtWidgets.QLineEdit(self.tab_1)
        self.projectBox.setGeometry(QtCore.QRect(480, 130, 111, 20))
        self.projectBox.setText("")
        self.projectBox.setObjectName("projectBox")
        self.resultTable = QtWidgets.QTableWidget(self.tab_1)
        self.resultTable.setGeometry(QtCore.QRect(10, 190, 761, 291))
        ...
        self.end_label = QtWidgets.QLabel(self.tab_1)
        self.end_label.setGeometry(QtCore.QRect(180, 40, 51, 21))
        ...
        self.value_label.setGeometry(QtCore.QRect(480, 40, 91, 21))
        self.value_label.setObjectName("value_label")
        self.para_label = QtWidgets.QLabel(self.tab_1)
        self.para_label.setGeometry(QtCore.QRect(350, 40, 91, 21))
        self.para_label.setObjectName("para_label")
        self.name_label = QtWidgets.QLabel(self.tab_1)
        self.name_label.setGeometry(QtCore.QRect(10, 100, 121, 21))
        ...
        self.nameBox = QtWidgets.QLineEdit(self.tab_1)
        self.nameBox.setGeometry(QtCore.QRect(10, 130, 113, 20))
        ...
        self.pathBox_tab2.setGeometry(QtCore.QRect(360, 70, 251, 20))
        self.pathBox_tab2.setText("")
        self.pathBox_tab2.setObjectName("pathBox_tab2")
        self.resultTable_tab2 = QtWidgets.QTableWidget(self.tab_2)
        self.resultTable_tab2.setGeometry(QtCore.QRect(10, 130, 961, 221))
        self.resultTable_tab2.setMinimumSize(QtCore.QSize(671, 0))
        self.resultTable_tab2.setObjectName("resultTable_tab2")
        self.resultTable_tab2.setColumnCount(9)
        self.resultTable_tab2.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.resultTable_tab2.setHorizontalHeaderItem(8, item)
        ...
        self.endBox_tab2 = QtWidgets.QLineEdit(self.tab_2)
        self.endBox_tab2.setGeometry(QtCore.QRect(110, 70, 61, 20))
        self.endBox_tab2.setText("")
        self.endBox_tab2.setObjectName("endBox_tab2")
...
"font: 75 10pt \"Verdana\";")
        ...
        self.startBox_tab2 = QtWidgets.QLineEdit(self.tab_2)
        self.startBox_tab2.setGeometry(QtCore.QRect(10, 70, 61, 20))
        self.startBox_tab2.setText("")
        self.startBox_tab2.setObjectName("startBox_tab2")
        ...
        self.path_label_tab2.setGeometry(QtCore.QRect(360, 40, 121, 21))
        self.path_label_tab2.setObjectName("path_label_tab2")
        self.name_label_tab2 = QtWidgets.QLabel(self.tab_2)
        self.name_label_tab2.setGeometry(QtCore.QRect(210, 40, 121, 21))
        ...
        self.nameBox_tab2.setGeometry(QtCore.QRect(210, 70, 113, 20))
        self.nameBox_tab2.setText("")
        self.nameBox_tab2.setObjectName("nameBox_tab2")
        self.limits_label = QtWidgets.QLabel(self.tab_2)
        self.limits_label.setGeometry(QtCore.QRect(10, 40, 51, 21))
        self.limits_label.setObjectName("limits_label")
        self.end_label_tab2 = QtWidgets.QLabel(self.tab_2)
        self.end_label_tab2.setGeometry(QtCore.QRect(110, 40, 51, 21))
        self.end_label_tab2.setObjectName("end_label_tab2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.resultTable_tab2.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Sensor Name"))
        item = self.resultTable_tab2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Project"))
        item = self.resultTable_tab2.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "ProbeID"))
        item = self.resultTable_tab2.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Fluence"))
        item = self.resultTable_tab2.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Strip Para"))
        item = self.resultTable_tab2.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Mean Value"))
        item = self.resultTable_tab2.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "StdErr"))
        item = self.resultTable_tab2.horizontalHeaderItem(7)
        ...
        self.limits_label.setText(_translate("MainWindow", "Start PID"))
        self.end_label_tab2.setText(_translate("MainWindow", "End PID"))
